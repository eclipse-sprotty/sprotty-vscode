...
import { boundsModule, buttonModule, configureModelElement, ConsoleLogger, defaultModule, expandModule, 
    ...
    SModelRoot, SRoutingHandle, SRoutingHandleView, CreateElementCommand, configureCommand, updateModule, 
    routingModule, ManhattanEdgeRouter, zorderModule
    //,edgeEditModule, edgeLayoutModule, labelEditModule
 } from 'sprotty';
...
export function createStateDiagramContainer(widgetId: string): Container {
    ...
    container.load(defaultModule, selectModule, moveModule, boundsModule, undoRedoModule, viewportModule,
        ...
        decorationModule, updateModule, routingModule, zorderModule,
        //edgeEditModule, edgeLayoutModule, labelEditModule, 
        statesDiagramModule);
